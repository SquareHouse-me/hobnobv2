...
@section('page_title', __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.'Business Owner')
...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.'Business Owner' }}
    </h1>
...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form"
              action="@if(!is_null($dataTypeContent->getKey())){{ route('voyager.'.$dataType->slug.'.business.update', $dataTypeContent->getKey()) }}@else{{ route('voyager.'.$dataType->slug.'.business.store') }}@endif"
                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="password">{{ __('voyager::generic.password') }} <span class="text-danger">*</span></label>
